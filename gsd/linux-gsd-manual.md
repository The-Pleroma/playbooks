...
| **CHECKPOINT**                                                        |
|                                                                       |
| You should now have: updated packages, Git installed, Node.js 18+,    |
| and npm installed.                                                    |
+-----------------------------------------------------------------------+
...
> sudo dpkg -i \~/Downloads/warp-terminal\_\*.deb
>
...
5.  **Go to:** windsurf.com/download

6.  **Download the Linux version.**

7.  **Run the installer** and follow the prompts.

8.  **Sign in** with Google or GitHub when prompted.

9.  **Choose Free tier** to start (upgrade later if needed).
...
| **IMPORTANT**                                                         |
|                                                                       |
| Never use sudo before the npm install command. Fix permissions        |
| instead.                                                              |
+-----------------------------------------------------------------------+

**First-Time Authentication**

10. **Open Warp** (or any terminal) and type: claude

11. **Claude Code opens a browser.** If it doesn't, copy the displayed
    URL and paste it in your browser.

12. **Log in** to your Claude account.

13. **Authorize Claude Code** when prompted.

14. **Return to your terminal.** Claude Code is now ready.
...
| Only use in project folders, never in system directories like / or    |
| /etc.                                                                 |
+-----------------------------------------------------------------------+
...
> mkdir \~/Developer/my-existing-project
>
...
15. Exit Claude Code (/exit or Ctrl+C).

16. Re-run: npx get-shit-done-cc@latest

17. Re-launch Claude Code and try /gsd:help again.
...
A: Yes. GNOME Terminal, Konsole, Alacritty, or any terminal works. Warp
just makes it nicer.
...
**One-Time Setup**
  ...
  **Step**              **Command**
  ...
  Install Node.js       curl -fsSL https://deb.nodesource.com/setup_20.x
